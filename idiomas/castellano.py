textos = {
    ...
    "opciones_nombre": "Si quiere formar parte del **sorteo**. Por favor ingrese su **Nombre y Apellido:** ",
    ...
    "opcion_correo": "Si quiere formar parte del **sorteo**. Por favor ingrese su **correo electrónico:** ",
    ...
    "pregunta_2_3": "Si ha utilizado la IA, ¿para qué la utiliza principalmente? (Puede seleccionar más de una respuesta). ", 
    "opciones_2_3": ["Uso personal", "Estudio académico", "Trabajo", "Otros" ], 
    
    "pregunta_2_4": "¿En qué ámbito utiliza con más frecuencia la IA?",
    ...
    "pregunta_2_5": "Pregunta sesgos IA", 
    "opciones_2_5": ["por determinar"], 
        
    "pregunta_2_6": "¿Cree que las personas estamos condicionados en la toma de decisiones?", 
    "opciones_2_6": ["Sí, siempre", "A menudo, depende de la decisión", "No, nunca"], 
    
    "pregunta_2_7": "¿Quién cree que posee más sesgos en la presa de decisiones, una persona o un sistema con IA?", 
    ...
    "intro_q34":  "Jake llevo a juicio a la compañía. Air Canada argumentó que su página web contenía la información correcta sobre cómo obtener el descuento y que lo que decía el chatbot no era válido. Sin embargo, en el juicio ese argumento no fue suficiente, ya que no había manera de demostrar que la página web era más fiable que la información proporcionada por el chatbot.  Por lo que, Air Canada terminó perdiendo el caso y tuvo que pagar a Jake Moffatt. ", 
    ...
    #Errores
    "error_genero": "Por favor, ingrese su género. ",
    "error_correo": "Correo electrónico no válido. ",
    "error_age": "Por favor, ingrese su edad. ",
    "error_nivel_estudios": "Por favor, ingrese su nivel de estudios. ",
    "error_rama_estudios": "Por favor, ingrese su rama de estudios. ", 
    "error_años_experiencia" : "Por favor, ingrese cuántos años de experiencia tiene en su ámbito de estudios.",
    "error_pais_residencia": "Por favor, ingrese su país de residencia.", 
